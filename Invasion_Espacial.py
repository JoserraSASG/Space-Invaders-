...
jugador_x = 368 #la mitad de la pantalla - la mitad del tamaño del icono
jugador_y = 500
jugador_x_cambio = 0
...
for e in range(cantidad_enemigos):
    ...
    enemigo_x.append(random.randint(0,736)) #la mitad de la pantalla - la mitad del tamaño del icono
...
#Puntaje
puntaje = 0
fuente = pygame.font.Font("Begok.ttf", 32)
texto_x = 10
texto_y = 10

#texto final de juego
fuente_final = pygame.font.Font("Begok.ttf", 80)
...
while se_ejecuta:
    ...
    for evento in pygame.event.get():
        ...
        #evento para saber si se suelta la tecla
